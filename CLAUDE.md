...
> ⚠️ **Lịch 2627-1 đổi 10 tuần × 3 tiết** (phòng đào tạo, 08/2026 — xem DECISIONS.md 17/08): 15 bài nội dung giữ nguyên, dạy dồn 10 tuần theo cách A (gộp 4 cặp): T1=bài 1+2, T3=bài 4+5, T5=bài 7+8, T9=bài 12+13; đơn T2=b3, T4=b6, T7=b10, T8=b11, T10=b14. **Bài 9=giữa kỳ (T6, chỉ thi, bỏ deck ôn); Bài 15=buổi riêng sau T10.** Quiz 4 bài (T3/5/7/9). Đối chứng BTL công bố sớm T2; mốc BTL proposal T6, final T10. Tổng 60 tiết (30/30) giữ nguyên. **Lịch chính tắc = `2627-1/index.html`** (cột Tuần↔Bài); nơi khác gỡ số tuần cứng. **Thuật ngữ học liệu SV: đơn vị bài giảng gọi "Bài N", không "Buổi N"** ("buổi" chỉ còn nghĩa phiên học).
